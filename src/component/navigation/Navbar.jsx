...
export default function Navbar() {
    ...
    // 2. Click Outside Event Handler (Closes dropdowns and mobile drawer)
    useEffect(() => {
                    ...
                    <div className="hidden lg:flex items-center space-x-1">
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`flex items-center space-x-1 px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${activeDropdown === 'careers' ? 'text-indigo-600 bg-indigo-50/50' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100/70'
                                    }`}
                            >
                        ...
                        <div className="relative">
                            <button
                                ...
                                className={`flex items-center space-x-1 px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${activeDropdown === 'colleges' ? 'text-indigo-600 bg-indigo-50/50' : 'text-slate-600 hover:text-slate-900 hover:bg-slate-100/70'
                                    }`}
                            >
